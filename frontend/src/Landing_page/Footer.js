...
//                         alt="Zerodha logo in blue text with a stylized Z symbol, representing the Zerodha financial services brand, displayed on a clean white background" 
//                         style={{ width: "50%" }} 
//                     />
    ...
    return (
        <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
            <div className="container border-top mt-5">
                ...
                <div className='mt-5 text-muted' style={{ fontSize: "14px" }}>
                    {/* Legal and Risk */}
                    <p>Zerodha Broking Ltd.: Member of NSE, BSE​ &​ MCX... (rest text remains same)</p>
                    <p>Procedure to file a complaint on SEBI SCORES: ...</p>
                    <p>Smart Online Dispute Resolution | Grievances Redressal Mechanism</p>
                    <p>Investments in securities market are subject to market risks...</p>
                    <p>Prevent unauthorised transactions in your account... </p>
                </div>
            </div>
        </footer>
    );
